...
```bash
npm run check:deb -- dist/knowledge-dump_0.1.1_amd64.deb
```
...
sha256sum --check knowledge-dump_0.1.1_amd64.deb.sha256
sudo apt install ./knowledge-dump_0.1.1_amd64.deb
